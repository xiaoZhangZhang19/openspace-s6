...
import "./UUPSNFTMarketV1.sol";

contract UUPSNFTMarketV2 is UUPSNFTMarketV1 {
    // 升级测试函数
    ...
    function listWithSignature(
        ...
        require(price > 0, "UUPSNFTMarketV2: price must be greater than zero");
        require(block.timestamp <= deadline, "UUPSNFTMarketV2: signature expired");
        ...
        require(signer != address(0) && signer == owner, "UUPSNFTMarketV2: invalid signature");
