...
contract NFTMarket is ERC20TokenReceiver, ERC721Holder, ReentrancyGuard {
    ...
    event NFTPurchasedByTokenReceived(uint256 indexed tokenId, address indexed buyer, address indexed seller);
    ...
    function tokensReceived(
        ...
        emit NFTPurchasedByTokenReceived(tokenId, from, listing.seller);
